module.exports = {
  ...
  'signUp.signUpSuccess': 'FesPayの登録が完了しました！お買い物をお楽しみください。',
  ...
  'howToUse.body1': 'レジスタッフに「FesPayで支払う」と伝えます。',
  'howToUse.title2': 'QRコードをスキャン',
  'howToUse.body2': '店頭端末(iPhone)のカメラにQRコードをかざします。',
  'howToUse.title3': '顔をカメラで認証',
  'howToUse.body3': 'レジスタッフが店頭端末(iPhone)であなたの顔を撮影します。',
  'howToUse.title4': '購入完了',
  'howToUse.body4': 'お買い上げいただきありがとうございました！！ 購入金額が登録したクレジットカードに請求されます。',
